      ...
      <div className="container" style={{ padding: '0 20px' }}>
        ...
        >
          <div className="subscribe-grid" style={{ 
            ...
            <div className="subscribe-content" style={{ maxWidth: '700px', width: '100%' }}>
              <h3 style={{ fontSize: '2.6rem', marginBottom: '16px', lineHeight: 1.1, fontWeight: 850 }}>
              ...
              <div className="store-buttons" style={{ 
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <span style={{ fontSize: '0.7rem', lineHeight: 1.1, letterSpacing: '0.01em', fontWeight: 500 }}>Available on the</span>
                    <span style={{ fontSize: '1.25rem', fontWeight: 700, lineHeight: 1.1, letterSpacing: '-0.02em' }}>App Store</span>
                  </div>
                </a>
